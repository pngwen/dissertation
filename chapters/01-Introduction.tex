...
about the structure of a corpus.
...
still a reasonable choice.  From this, 3-grams will be used in the
tests in this dissertation.  The analysis performed in Antonia
...
only used as an evidenciary marker of an author's participation.  One
